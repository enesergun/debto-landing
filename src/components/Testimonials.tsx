...
const Testimonials: React.FC = () => {
    ...
    const testimonialsObj = t('testimonials', { returnObjects: true }) as Record<string, { name: string; role: string; message: string; avatar: string }>;
    const testimonials = Object.values(testimonialsObj);
