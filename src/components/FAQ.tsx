...
const FAQ: React.FC = () => {
  ...
  const faqsObj = t('faq', { returnObjects: true }) as Record<string, { question: string; answer: string }>;
  const faqs = Object.values(faqsObj);

  return (
    <section id="sss" className="py-10 lg:py-20">
      <div className="flex flex-col lg:flex-row gap-10">
        <div className="">
          <p className="hidden lg:block text-foreground-accent">{t('faqSection.intro')}</p>
          <SectionTitle>
